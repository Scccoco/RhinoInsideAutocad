...
---
### Первый запуск
В компонентах прописаны пути к библиотекам AutoCAD (acmgd.dll, accoremgd.dll и т.д.) с указанием версии - сейчас 2020.
Если у тебя другая версия AutoCAD (2021, 2022, 2023 или 2024) - при первом запуске компоненты выдадут ошибку загрузки сборки.
Что делать:

Открой любой компонент (двойной клик на C# скрипт).
В разделе #region Usings найди строки #r с путями типа "C:\Program Files\Autodesk\AutoCAD 2020\..."
Замени "2020" на свою версию (например, "2024").
Сохрани компонент.
Готово - теперь работает на твоей версии.
